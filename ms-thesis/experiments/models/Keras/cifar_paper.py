...
from keras.layers import Conv3D, Conv2D, MaxPooling2D, BatchNormalization
...
'''
model.add(Conv3D(rank1, kernel_size=(3, 1, 1), strides=(1, 1, 1)))
model.add(Conv3D(rank1, kernel_size=(1, 3, 1), strides=(1, 1, 1)))
'''
...
Reshape(batch, height, width, 1, channels)
...
model.add(Conv2D(rank1, kernel_size=(1, 1), padding='same'))
model.add(BatchNormalization())
