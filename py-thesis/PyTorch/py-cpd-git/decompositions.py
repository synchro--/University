...
def cp_decomposition_conv_layer(layer, rank):
    ...
    new_layers = [pointwise_s_to_r_layer, bn_first, depthwise_vertical_layer, bn_middle, \
                    depthwise_horizontal_layer, bn_middle, pointwise_r_to_t_layer, bn_last]
...
def cp_decomposition_conv_layer_BN(layer, rank):
    ...
    bn_middle = nn.BatchNorm2d(vertical.shape[1]) 
