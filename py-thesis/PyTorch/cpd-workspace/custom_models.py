...
class CPD_Zhang(nn.Module):
    ...
    def __init__(self, rank1, rank2, rankFC, relu=False):
        ...
        self.cpdfc2 = nn.Conv2d(
            rankFC, rankFC, (last_kernel_sz, 1), groups=rankFC)
        self.cpdfc3 = nn.Conv2d(
            rankFC, rankFC, (1, last_kernel_sz), groups=rankFC)
