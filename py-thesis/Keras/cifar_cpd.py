...
model.add(Conv2D(rank1, kernel_size=(1, 1), padding='same', input_shape=x_train.shape[1:])) 
model.add(BatchNormalization())
model.add(Conv2D(rank1, kernel_size=(3, 1)))
model.add(BatchNormalization())
model.add(Conv2D(rank1, kernel_size=(1, 3)))
model.add(BatchNormalization())
...
model.add(BatchNormalization())
model.add(Conv2D(rank2, kernel_size=(3, 1)))
model.add(BatchNormalization())
model.add(Conv2D(rank2, kernel_size=(1, 3)))
model.add(BatchNormalization())
model.add(Conv2D(64, kernel_size=(1, 1)))
model.add(Activation('relu'))
