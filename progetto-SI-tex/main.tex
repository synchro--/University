...
\thesistitle{Reti neurali artificiali: dal MLP alle più recenti CNN} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\subject{Intelligenza Artificiale} % Your subject area, this is not currently used anywhere in the template, print it elsewhere with \subjectname
\keywords{} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
\university{\href{http://www.university.com}{Università di Bologna}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
...
\textit{Attività progettuale di Sistemi Intelligenti M}\\[0.5cm] % Thesis type
...
Nel \emph{Capitolo 1} viene fornita un'introduzione alle reti neurali, finendo nella proposta di un problema da risolvere con un percettrone multi-strato; nel \emph{Capitolo 2} si percorre passo passo l'implementazione da zero di quest'ultimo, fino a portare a termine l'effettivo addestramento; il \emph{Capitolo 3} introduce le Convolutional Neural Networks, ne spiega l'architettura ed i loro ultimi successi; nel \emph{Capitolo 4} vengono implementate queste reti e provate su un due dataset diversi; il \emph{Capitolo 5} presenta un'architettura allo stato dell'arte che viene testata sullo stesso dataset e confrontata con quella del capitolo precedente; nel \emph{Capitolo 6} viene analizzato un caso d'uso industriale della classificazione, affrontato sfruttando il transfer-learning; il \emph{Capitolo 7}, infine, tira le somme e conclude l'elaborato.
\ldots
\end{abstract}
%\end{comment}
