...
\thesistitle{Reti neurali artificiali: dal MLP alle più recenti architetture di Convolutional Neural Networks} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
{\large 1 Settembre 2017}\\[4cm] % Date
