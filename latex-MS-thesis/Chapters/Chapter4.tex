...
\begin{figure}[h!]
 \centering
 \includegraphics[width=1.0\textwidth]{\path/TP-block.jpg} 
...
\begin{figure}[h!]
 ...
 \caption{VBMF rank estimation of a convolutional tensor: first off the tensor is reshaped into an $S \times d^2 \times T$ three-way tensor; secondly it is unfolded along each of the modes; 
 thirdly each of the k-unfolding matrices is given as an input to the VBMF algorithm and a rank is estimated; lastly the effective choice of the rank. We can take the highest rank to be more accurate; 
 the lowest to apply a more aggressive decomposition; an average of all three for a trade-off.}}
 \label{fig:vbmf}
\end{figure}
...
\begin{figure}[h!]
 \centering
 \includegraphics[width=1.0\textwidth]{\path/tensor-vec3.jpg} 
...
\begin{figure}[h!]
 ...
 \caption{An Higher Order SVD of a third-order rank-(R1-R2-R3) tensor and the different spaces.}
 \label{fig:hosvd}
\end{figure}
